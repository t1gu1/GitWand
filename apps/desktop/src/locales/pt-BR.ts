...
const ptBR: Locale = {
  ...
  commitCtx: {
    ...
    resetSoft: "Reset (Soft) — mantém alterações do índice e do diretório de trabalho",
    resetMixed: "Reset (Mixed) — desindexa alterações, mantém arquivos",
    resetHard: "Reset (Hard) — descarta TODAS as alterações",
