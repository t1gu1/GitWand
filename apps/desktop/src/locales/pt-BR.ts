...
const ptBR: Locale = {
  ...
  commitCtx: {
    ...
    copyShortSha: "Copiar ID curto do commit",
    copyFullSha: "Copiar ID completo do commit",
  ...
  tags: {
    ...
    retagRefLabel: "Ref alvo (branch, ID do commit ou HEAD)",
    retagRefHint: "Deixe vazio para mover para HEAD. Para um commit específico, cole seu ID.",
