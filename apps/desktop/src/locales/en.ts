...
const en = {
  ...
  commitCtx: {
    ...
    resetSoft: "Reset (Soft) \u2014 keeps staged and working-tree changes",
    resetMixed: "Reset (Mixed) \u2014 unstages changes, keeps working-tree files",
    resetHard: "Reset (Hard) \u2014 discards ALL changes",
