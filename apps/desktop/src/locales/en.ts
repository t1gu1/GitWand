...
const en = {
  ...
  commitCtx: {
    ...
    copyShortSha: "Copy short commit ID",
    copyFullSha: "Copy full commit ID",
  ...
  tags: {
    ...
    retagRefLabel: "Target ref (branch, commit ID, or HEAD)",
    retagRefHint: "Leave empty to move to HEAD. For a specific commit, paste its ID.",
