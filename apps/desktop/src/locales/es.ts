...
const es: Locale = {
  ...
  commitCtx: {
    ...
    resetSoft: "Reset (Soft) — conserva cambios del índice y el directorio de trabajo",
    resetMixed: "Reset (Mixed) — desindexa cambios, conserva archivos",
    resetHard: "Reset (Hard) — descarta TODOS los cambios",
