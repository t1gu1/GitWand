...
const es: Locale = {
  ...
  commitCtx: {
    ...
    copyShortSha: "Copiar ID corto del commit",
    copyFullSha: "Copiar ID completo del commit",
  ...
  tags: {
    ...
    retagRefLabel: "Ref destino (rama, ID commit o HEAD)",
    retagRefHint: "Dejar vacío para mover a HEAD. Para un commit específico, pegar su ID.",
