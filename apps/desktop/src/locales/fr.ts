...
const fr: Locale = {
  ...
  commitCtx: {
    ...
    resetSoft: "Reset (Soft) — conserve l'index et les fichiers modifiés",
    resetMixed: "Reset (Mixed) — désindexe les changements, conserve les fichiers",
    resetHard: "Reset (Hard) — abandonne TOUS les changements",
