...
const fr: Locale = {
  ...
  commitCtx: {
    ...
    copyShortSha: "Copier l'ID court du commit",
    copyFullSha: "Copier l'ID complet du commit",
  ...
  tags: {
    ...
    retagRefLabel: "Ref cible (branche, ID commit ou HEAD)",
    retagRefHint: "Laisser vide pour déplacer vers HEAD. Pour un commit précis, coller son ID.",
